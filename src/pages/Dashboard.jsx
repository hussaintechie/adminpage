  ...
  return (
    <div className="max-w-7xl mx-auto space-y-6 md:space-y-8 p-4 md:p-6 animate-in fade-in duration-300">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        <StatCard title="Total Orders" value={orderCount} icon={ShoppingBasket} color="bg-blue-500" trend={12.5} />
        <StatCard title="Total Revenue" value={`₹${revenue.toLocaleString()}`} icon={DollarSign} color="bg-emerald-500" trend={8.2} />
        <StatCard title="Pending Orders" value="5" icon={Clock} color="bg-amber-500" trend={-2.4} />
