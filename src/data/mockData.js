...
export const LOW_STOCK_DATA = [
  ...
  { id: 5, name: 'Coca Cola (2L)', stock: 1, category: 'Beverages' },
  { id: 6, name: 'Amul Butter (500g)', stock: 1, category: 'Dairy' },
  { id: 7, name: 'Farm Fresh Eggs (12pcs)', stock: 1, category: 'Dairy' },
  { id: 8, name: 'Organic Tomatoes', stock: 1, category: 'Vegetables' },
  { id: 9, name: 'Whole Wheat Bread', stock: 1, category: 'Bakery' },
  { id: 10, name: 'Coca Cola (2L)', stock: 1, category: 'Beverages' },
  { id: 11, name: 'Amul Butter (500g)', stock: 1, category: 'Dairy' },
  { id: 12, name: 'Farm Fresh Eggs (12pcs)', stock: 1, category: 'Dairy' },
  { id: 13, name: 'Organic Tomatoes', stock: 1, category: 'Vegetables' },
  { id: 14, name: 'Whole Wheat Bread', stock: 1, category: 'Bakery' },
  { id: 15, name: 'Coca Cola (2L)', stock: 1, category: 'Beverages' },
...
export const EXISTING_PRODUCTS = [
  ...
  { id: 4, name: 'Toned Milk', sku: 'DAIRY-004', stock: 18, price: 32.00, mrp: 35.00, category: 'Dairy', status: 'Low Stock' }, // Changed stock to 18 for demo
  { id: 5, name: 'Curd (500g)', sku: 'DAIRY-005', stock: 15, price: 30.00, mrp: 32.00, category: 'Dairy', status: 'Low Stock' },
   { id: 6, name: 'Amul Butter', sku: 'DAIRY-001', stock: 45, price: 54.00, mrp: 60.00, category: 'Dairy', status: 'Active' },
  { id: 7, name: 'Farm Eggs (6pcs)', sku: 'DAIRY-002', stock: 12, price: 40.00, mrp: 50.00, category: 'Dairy', status: 'Low Stock' },
  { id: 8, name: 'Whole Wheat Bread', sku: 'BAK-101', stock: 0, price: 35.00, mrp: 40.00, category: 'Bakery', status: 'Out of Stock' },
  { id: 9, name: 'Toned Milk', sku: 'DAIRY-004', stock: 18, price: 32.00, mrp: 35.00, category: 'Dairy', status: 'Low Stock' }, // Changed stock to 18 for demo
  { id: 10, name: 'Curd (500g)', sku: 'DAIRY-005', stock: 15, price: 30.00, mrp: 32.00, category: 'Dairy', status: 'Low Stock' },
   { id: 11, name: 'Amul Butter', sku: 'DAIRY-001', stock: 45, price: 54.00, mrp: 60.00, category: 'Dairy', status:'Active' },
   { id :12,name:'Farm Eggs (6pcs)', sku:'DAIRY-OO2', stock :12 ,price :40.00 ,mrp :50.00 ,category :'Dairy' ,status :'Low Stock'},
   { id :13,name:'Whole Wheat Bread ',sku :'BAK-IOI ',stock :0 ,price :35.00 ,mrp :40.00 ,category :'Bakery ',status :'Out of Stock'},
   { id :14,name:'Toned Milk ',sku :'DAIRY-OOS ',stock :18 ,price :32.00 ,mrp :35.00 ,category :'Dairy ',status :'Low Stock'}, // Changed stock to 18 for demo
   { id :15,name:'Curd (5OOg) ',sku :'DAIRY-OOS ',stock :15 ,price :30.00 ,mrp :32.00 ,category :'Dairy ',status :'Low Stock'},
  { id: 16, name: 'Whole Wheat Bread', sku: 'BAK-101', stock: 0, price: 35.00, mrp: 40.00, category: 'Bakery', status: 'Out of Stock' },
  { id: 17, name: 'Toned Milk', sku: 'DAIRY-004', stock: 18, price: 32.00, mrp: 35.00, category: 'Dairy', status: 'Low Stock' }, // Changed stock to 18 for demo
  { id: 18, name: 'Curd (500g)', sku: 'DAIRY-005', stock: 15, price: 30.00, mrp: 32.00, category: 'Dairy', status: 'Low Stock' },
];
