    ...
    return (
      <div className="bg-slate-800 text-white p-3 rounded-lg shadow-xl border border-slate-700 text-sm">
        ...
        <p className="font-bold text-lg flex items-center gap-1">
          ...
          <span className="text-[10px] bg-emerald-500/20 text-emerald-400 px-1.5 py-0.5 rounded ml-2">
            +4.2%
          </span>
        </p>
      </div>
...
const Dashboard = () => {
  ...
  const Chartapi_URL =
    "https://api.sribalajistores.com/product/getChartdetails";
  ...
  const handleDashboard = async () => {
    ...
    try {
      ...
      if (res.data?.status === 1 && apiData) {
        ...
        console.log(
          lowstockdetailsres,
          "lowstockdetailsreslowstockdetailsreslowstockdetailsres"
        );
  ...
  return (
    <div className="max-w-7xl mx-auto space-y-6 md:space-y-8 p-4 md:p-6 animate-in fade-in duration-300">
      ...
      <div className="flex justify-between items-end">
        <div>
          ...
          <p className="text-slate-500 mt-1">
            Real-time updates for Wake Up Servicios
          </p>
        </div>
        ...
        <div className="bg-white p-6 rounded-2xl shadow-sm border border-slate-200 flex flex-col h-full">
          ...
          <div className="space-y-3 overflow-y-auto flex-1 pr-1 custom-scrollbar">
            {lowstockData.map((item) => (
              <div
                key={item.id}
                className="flex items-center justify-between p-3 bg-slate-50/50 hover:bg-slate-50 rounded-xl border border-slate-100 transition-colors group"
              >
      ...
      <div className="space-y-4">
        ...
        {recentOrders.map(order => (
  <div key={order.order_id} className="bg-white p-4 rounded-xl">
